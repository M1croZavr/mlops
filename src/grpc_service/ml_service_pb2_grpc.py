...
class MLServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Predict = channel.unary_unary(
                '/MLService/Predict',
                request_serializer=ml__service__pb2.LoadPredRequest.SerializeToString,
                response_deserializer=ml__service__pb2.LoadPredResponse.FromString,
                _registered_method=True)
...
def add_MLServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'Predict': grpc.unary_unary_rpc_method_handler(
                    servicer.Predict,
                    request_deserializer=ml__service__pb2.LoadPredRequest.FromString,
                    response_serializer=ml__service__pb2.LoadPredResponse.SerializeToString,
            ),
    }
...
class MLService(object):
    ...
    def Predict(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/MLService/Predict',
            ml__service__pb2.LoadPredRequest.SerializeToString,
            ml__service__pb2.LoadPredResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
